...
contract MajewskiToken is ERC20Capped, ERC20Burnable {
    address payable public owner;
    uint public blockReward;
    constructor(uint cap, uint reward) ERC20("MajewskiToken", "MST") ERC20Capped(cap * (10 ** decimals())) {
